...
extern int		DEBUGMODE;					/* Send Debug-output to Sniffer-Server (TCP/IP) and to console */
extern char		SNIFFERHOST[MAX_CHAR];	// Debugserver (Sniffer) hostname
extern int		SNIFFERPORT;				// Debugserver (Sniffer) port
